...
bool tickFunc(Core *core)
{
	...
	{	
		...
		Signal alu_in_1 = MUX(ID_reg_load.signals.ALUSrc,ID_reg_load.read_reg_val_2,ID_reg_load.imm_sign_extended);		
		alu_in_1 = MUX_3_to_1(Forward_B,alu_in_1,M_reg_load.alu_result,WB_reg_load.reg_write_mux_val);
		alu_in_0 = ID_reg_load.read_reg_val_1;
		alu_in_0 = MUX_3_to_1(Forward_A,alu_in_0,M_reg_load.alu_result,WB_reg_load.reg_write_mux_val);
					...
					
{
	*Forward_A, *Forward_B =0 ;
	...
	~(E_ reg_load.RegWrite && (E_reg_load.write_reg != 0)) &&
	((E_reg_load.write_reg = ID_reg_load.eg_read_index_1)) &&
	(M_reg_load.write_reg = ID_reg_load.eg_read_index_1)
	)
	{
		*Forward_A = 1;
	}
	...
	((E_reg_load.write_reg = ID_reg_load.eg_read_index_2)) &&
	(M_reg_load.write_reg = ID_reg_load.eg_read_index_2)
	)
	{
		*Forward_B = 1;
	}  */
